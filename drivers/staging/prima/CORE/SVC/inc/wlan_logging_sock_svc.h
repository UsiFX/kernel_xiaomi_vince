...
#else
#define wlan_process_done_indication(...)
#define wlan_logging_sock_activate_svc(...) 0
#define wlan_flush_host_logs_for_fatal(...)
#define wlan_init_log_completion(...)
#define wlan_set_log_completion(...) 0
#define wlan_get_log_and_reset_completion(...)
#define wlan_is_log_report_in_progress(...) 0
#define wlan_reset_log_report_in_progress(...)
#define wlan_deinit_log_completion(...)
#define wlan_logging_set_log_level(...)
#endif
...
#else
#define wlan_indicate_mem_dump_complete(...)
#define wlan_store_fwr_mem_dump_size(...)
#define wlan_free_fwr_mem_dump_buffer(...)
#define wlan_is_logger_thread(...) 0
#define wlan_pkt_stats_to_user(...) 0
#define wlan_disable_and_flush_pkt_stats(...)
#define wlan_fillTxStruct(...)
#define wlan_isPktStatsEnabled(...) 0
#endif
...
void wlan_report_log_completion(uint32 is_fatal,
      ...
      uint32 reason_code);
#else
#define wlan_report_log_completion(...)
#endif
#else
